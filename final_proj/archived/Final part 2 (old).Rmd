...
The model show lift as expected.
...
The models evaluated (OLS, LASSO, Elastic Net) did not perform as expected, failing to demonstrate a consistent lift in treatment effects across score groups according to the lift graphs produced on the validation data set.
...
During the analysis, I encounter challenges including model overfitting, variability of results and limited lift outcome.
